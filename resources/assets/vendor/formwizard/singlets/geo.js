;(function(){
  ...
  $(document).ready(function(){
    ...
    var code = window.geo.getCountryCode();

    $('.phonelist-dropdown, .country-dropdown').each(function(){


      var option = $(this).find('[data-country-code="' + code + '"]')[0];
